...
<details>
  ...
  <ol>
    ...
    <li><a href="bash/house/house.sh">House</a></li>
    <li><a href="bash/largest-series-product/largest_series_product.sh">Largest Series Product</a></li>
    <li><a href="bash/leap/leap.sh">Leap</a></li>
    <li><a href="bash/line-up/line_up.sh">Line Up</a></li>
    <li><a href="bash/pangram/pangram.sh">Pangram</a></li>
    <li><a href="bash/raindrops/raindrops.sh">Raindrops</a></li>
    <li><a href="bash/resistor-color/resistor_color.sh">Resistor Color</a></li>
    <li><a href="bash/resistor-color-duo/resistor_color_duo.sh">Resistor Color Duo</a></li>
    <li><a href="bash/rna-transcription/rna_transcription.sh">Rna Transcription</a></li>
    <li><a href="bash/scrabble-score/scrabble_score.sh">Scrabble Score</a></li>
    <li><a href="bash/secret-handshake/secret_handshake.sh">Secret Handshake</a></li>
    <li><a href="bash/series/series.sh">Series</a></li>
    <li><a href="bash/sublist/sublist.sh">Sublist</a></li>
    <li><a href="bash/acronym/acronym.sh">Acronym</a></li>
    <li><a href="bash/anagram/anagram.sh">Anagram</a></li>
    <li><a href="bash/bob/bob.sh">Bob</a></li>
    <li><a href="bash/bottle-song/bottle_song.sh">Bottle Song</a></li>
    <li><a href="bash/clock/clock.sh">Clock</a></li>
    ...
    <li><a href="bash/perfect-numbers/perfect_numbers.sh">Perfect Numbers</a></li>
    <li><a href="bash/phone-number/phone_number.sh">Phone Number</a></li>
    <li><a href="bash/prime-factors/prime_factors.sh">Prime Factors</a></li>
    <li><a href="bash/protein-translation/protein_translation.sh">Protein Translation</a></li>
    <li><a href="bash/proverb/proverb.sh">Proverb</a></li>
    <li><a href="bash/queen-attack/queen_attack.sh">Queen Attack</a></li>
    <li><a href="bash/resistor-color-trio/resistor_color_trio.sh">Resistor Color Trio</a></li>
    <li><a href="bash/rotational-cipher/rotational_cipher.sh">Rotational Cipher</a></li>
    <li><a href="bash/sieve/sieve.sh">Sieve</a></li>
    ...
    <li><a href="bash/binary-search/binary_search.sh">Binary Search</a></li>
    <li><a href="bash/diamond/diamond.sh">Diamond</a></li>
    <li><a href="bash/gigasecond/gigasecond.sh">Gigasecond</a></li>
    ...
    <li><a href="bash/crypto-square/crypto_square.sh">Crypto Square</a></li>
    <li><a href="bash/diffie-hellman/diffie_hellman.sh">Diffie Hellman</a></li>
    ...
    <li><a href="bash/simple-cipher/simple_cipher.sh">Simple Cipher</a></li>
    <li><a href="bash/tournament/tournament.sh">Tournament</a></li>
    <li><a href="bash/transpose/transpose.sh">Transpose</a></li>
    ...
    <li><a href="bash/spiral-matrix/spiral_matrix.sh">Spiral Matrix</a></li>
